...
function nuevo_producto() {
    // 1️⃣ Pedir las opciones al backend
    ...
    .then(data => {
        ...
        // 2️⃣ Construir selects dinámicos
        ...
        Swal.fire({
            ...
            width: '700px',
            didOpen: () => {
                // Mostrar/ocultar campos si eligen "Nueva" en categoría
                document.getElementById('new-categoria-select').addEventListener('change', (e) => {
                    document.getElementById('new-categoria-text').style.display = e.target.value === 'nueva' ? 'block' : 'none';
                });

                // Mostrar/ocultar campos si eligen "Nueva" en unidad
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('btn-nuevo-producto').addEventListener('click', nuevo_producto);
